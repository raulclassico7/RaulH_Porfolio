                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <span className="navbar-text">
                        <div className="social-icon">
                            <a href="https://www.linkedin.com/in/raul-hernan-damazo-chang/" target="_blank" rel='noopener noreferrer'><img src={navIcon1} alt="" /></a>
                            <a href="https://github.com/raulclassico7" target="_blank" rel='noopener noreferrer'><img className="git-icon" src={navIcon2} alt="" /></a>
